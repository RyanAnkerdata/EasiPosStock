...
public class EasiPosStockEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<EasiPosStockDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also EasiPosStockDbContextFactory for EF Core tooling. */
