...
public class EasiPosStockDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public EasiPosStockDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
